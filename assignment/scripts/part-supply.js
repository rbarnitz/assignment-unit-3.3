...
var supplyChangesInt = [1, 4, 6, 9, 0]; 


console.log(supplyChangesInt[1]+supplyChangesInt[3]);

var totalParts;

for (let i = 0; i<supplyChangesInt.length; i++){
    totalParts = (totalParts + supplyChanges);
